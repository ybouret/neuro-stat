...
#parallel
stamp=proc.time();
counts_par = wink_bootstrap_counts(neurons[[1]],neurons[[2]],intervals,delta,B,num_threads);
...
stamp=proc.time();
counts_ser = wink_bootstrap_counts(neurons[[1]],neurons[[2]],intervals,delta,B,1);
